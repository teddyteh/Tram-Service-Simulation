...
public class TrackingService3Impl implements TrackingService {
	public static final String host = "localhost";
	public static final int portNo = 4446;
	...
	public static TrackingService getInstance() throws RemoteException {
		if (instance == null) {
			instance = new TrackingService3Impl();
	...
	// Default constructor
	public TrackingService3Impl() throws RemoteException {
